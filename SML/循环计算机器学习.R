...
expression <- data.frame(seed.select,kappa4.1_4)
expression
summary(expression)
...
expression <- data.frame(seed,kappa4.1_4)
expression
summary(expression)

expression.svm <- data.frame(seed,kappa.linear4.1_4,kappa.polynomial4.1_4,kappa.sigmoid4.1_4,kappa.radial4.1_4)
expression.svm
